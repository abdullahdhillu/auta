...
export const createAutomations = async (id?: string) => {
  ...
  try {
    ...
    return { status: 404, data: "Error in getAllAutomations function" };
  } catch (error) {
...
export const updateAutomationName = async (
  ...
  try {
    ...
    return { status: 404, data: "Oops! Could'nt find automation" };
  } catch (error) {
...
export const saveKeyword = async (automationId: string, keyword: string) => {
  ...
  try {
    ...
    if (create) return { status: 200, data: "Keyword addded successfully" };
...
export const getProfilePosts = async () => {
  ...
  try {
    ...
    return { status: 500, data: "Server side error in getting posts" };
  }
};
