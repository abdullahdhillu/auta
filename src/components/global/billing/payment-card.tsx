    ...
    >
      ...
      >
        ...
        <p className="text-gray-400 text-sm mb-2">
          This is what your plan covers for automtions and Ai features
        </p>
        {label === "PRO" ? (
          ...
          <p className="font-bold mt-2 text-gray-400">Standard</p>
        )}
        ...
        {landing ? (
          <Button
            className={cn(
              "rounded-full mt-5",
              label === "PRO"
                ? "bg-gradient-to-r from from-indigo-500 text-white via-purple-500 to-pink-500"
